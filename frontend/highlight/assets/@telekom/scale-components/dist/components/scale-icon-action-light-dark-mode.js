...
const ActionLightDarkMode = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-action-light-dark-mode", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-light-dark-mode"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-light-dark-mode":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionLightDarkMode);
      }
      break;
  } });
}

const ScaleIconActionLightDarkMode = ActionLightDarkMode;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionLightDarkMode, defineCustomElement };
