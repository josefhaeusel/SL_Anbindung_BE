...
const ContentRoute = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-route"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-route":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentRoute);
      }
      break;
  } });
}

const ScaleIconContentRoute = ContentRoute;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentRoute, defineCustomElement };
