...
const TProductVoice = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-t-product-voice"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-t-product-voice":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, TProductVoice);
      }
      break;
  } });
}

const ScaleIconTProductVoice = TProductVoice;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconTProductVoice, defineCustomElement };
