...
const ContentThreats = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-threats"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-threats":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentThreats);
      }
      break;
  } });
}

const ScaleIconContentThreats = ContentThreats;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentThreats, defineCustomElement };
