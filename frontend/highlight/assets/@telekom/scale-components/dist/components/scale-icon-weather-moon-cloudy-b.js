...
const WeatherMoonCloudyB = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-moon-cloudy-b", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-moon-cloudy-b"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-moon-cloudy-b":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherMoonCloudyB);
      }
      break;
  } });
}

const ScaleIconWeatherMoonCloudyB = WeatherMoonCloudyB;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherMoonCloudyB, defineCustomElement };
