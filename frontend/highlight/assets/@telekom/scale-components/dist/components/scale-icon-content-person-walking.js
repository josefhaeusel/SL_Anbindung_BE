...
const ContentPersonWalking = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-person-walking", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-person-walking"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-person-walking":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentPersonWalking);
      }
      break;
  } });
}

const ScaleIconContentPersonWalking = ContentPersonWalking;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentPersonWalking, defineCustomElement };
