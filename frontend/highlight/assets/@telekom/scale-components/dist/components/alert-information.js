...
const AlertInformation = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-alert-information", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement() {
  ...
  const components = ["scale-icon-alert-information"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-alert-information":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, AlertInformation);
      }
      break;
  } });
}

export { AlertInformation as A, defineCustomElement as d };
