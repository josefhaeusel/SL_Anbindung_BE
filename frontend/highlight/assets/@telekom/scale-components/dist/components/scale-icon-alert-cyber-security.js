...
const AlertCyberSecurity = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-alert-cyber-security", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-alert-cyber-security"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-alert-cyber-security":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, AlertCyberSecurity);
      }
      break;
  } });
}

const ScaleIconAlertCyberSecurity = AlertCyberSecurity;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconAlertCyberSecurity, defineCustomElement };
