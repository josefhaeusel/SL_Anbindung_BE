...
const ContentAndroid = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-android"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-android":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentAndroid);
      }
      break;
  } });
}

const ScaleIconContentAndroid = ContentAndroid;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentAndroid, defineCustomElement };
