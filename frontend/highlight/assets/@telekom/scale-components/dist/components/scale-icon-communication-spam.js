...
const CommunicationSpam = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-spam", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-spam"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-spam":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationSpam);
      }
      break;
  } });
}

const ScaleIconCommunicationSpam = CommunicationSpam;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationSpam, defineCustomElement };
