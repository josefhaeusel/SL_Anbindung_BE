...
const ContentId = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-id"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-id":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentId);
      }
      break;
  } });
}

const ScaleIconContentId = ContentId;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentId, defineCustomElement };
