...
const UserFileImageFile = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-user-file-image-file", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-user-file-image-file"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-user-file-image-file":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UserFileImageFile);
      }
      break;
  } });
}

const ScaleIconUserFileImageFile = UserFileImageFile;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconUserFileImageFile, defineCustomElement };
