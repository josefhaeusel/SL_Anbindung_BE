...
const ActionArrowUp = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-arrow-up"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-arrow-up":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionArrowUp);
      }
      break;
  } });
}

const ScaleIconActionArrowUp = ActionArrowUp;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionArrowUp, defineCustomElement };
