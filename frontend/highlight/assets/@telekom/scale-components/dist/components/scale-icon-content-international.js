...
const ContentInternational = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-international", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-international"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-international":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentInternational);
      }
      break;
  } });
}

const ScaleIconContentInternational = ContentInternational;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentInternational, defineCustomElement };
