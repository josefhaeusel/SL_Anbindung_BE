...
const ContentVoucher = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-voucher"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-voucher":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentVoucher);
      }
      break;
  } });
}

const ScaleIconContentVoucher = ContentVoucher;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentVoucher, defineCustomElement };
