  ...
  constructor(hostRef) {
    ...
    this.update = async () => {
      ...
      const { x, y, placement, middlewareData } = await floatingUi_dom_esm.computePosition(this.triggerEl, this.tooltipEl, {
        ...
        platform: Object.assign(Object.assign({}, floatingUi_dom_esm.platform), { getOffsetParent: (element) => floatingUi_dom_esm.platform.getOffsetParent(element, offsetParent) }),
      });
