...
const ActionArrowDown = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-action-arrow-down", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-arrow-down"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-arrow-down":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionArrowDown);
      }
      break;
  } });
}

const ScaleIconActionArrowDown = ActionArrowDown;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionArrowDown, defineCustomElement };
