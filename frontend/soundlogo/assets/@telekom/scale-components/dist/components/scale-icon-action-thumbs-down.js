...
const ActionThumbsDown = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-action-thumbs-down", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-thumbs-down"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-thumbs-down":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionThumbsDown);
      }
      break;
  } });
}

const ScaleIconActionThumbsDown = ActionThumbsDown;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionThumbsDown, defineCustomElement };
