...
const DeviceReplacementMobilephone = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-replacement-mobilephone", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-replacement-mobilephone"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-replacement-mobilephone":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceReplacementMobilephone);
      }
      break;
  } });
}

const ScaleIconDeviceReplacementMobilephone = DeviceReplacementMobilephone;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceReplacementMobilephone, defineCustomElement };
