...
const ProcessSepaTransaction = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-process-sepa-transaction", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-process-sepa-transaction"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-process-sepa-transaction":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ProcessSepaTransaction);
      }
      break;
  } });
}

const ScaleIconProcessSepaTransaction = ProcessSepaTransaction;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconProcessSepaTransaction, defineCustomElement };
