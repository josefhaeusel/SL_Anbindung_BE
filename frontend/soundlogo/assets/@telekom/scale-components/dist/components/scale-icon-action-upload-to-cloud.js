...
const ActionUploadToCloud = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-action-upload-to-cloud", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-upload-to-cloud"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-upload-to-cloud":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionUploadToCloud);
      }
      break;
  } });
}

const ScaleIconActionUploadToCloud = ActionUploadToCloud;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionUploadToCloud, defineCustomElement };
