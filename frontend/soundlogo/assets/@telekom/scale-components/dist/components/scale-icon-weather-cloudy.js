...
const WeatherCloudy = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-cloudy"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-cloudy":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherCloudy);
      }
      break;
  } });
}

const ScaleIconWeatherCloudy = WeatherCloudy;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherCloudy, defineCustomElement };
