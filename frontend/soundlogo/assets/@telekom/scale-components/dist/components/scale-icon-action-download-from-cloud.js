...
const ActionDownloadFromCloud = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-action-download-from-cloud", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-download-from-cloud"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-download-from-cloud":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionDownloadFromCloud);
      }
      break;
  } });
}

const ScaleIconActionDownloadFromCloud = ActionDownloadFromCloud;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionDownloadFromCloud, defineCustomElement };
