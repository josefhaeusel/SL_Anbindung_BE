...
const ContentDigitalBanking = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-digital-banking", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-digital-banking"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-digital-banking":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentDigitalBanking);
      }
      break;
  } });
}

const ScaleIconContentDigitalBanking = ContentDigitalBanking;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentDigitalBanking, defineCustomElement };
