...
const ServiceDevicesService = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-service-devices-service", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-service-devices-service"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-service-devices-service":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ServiceDevicesService);
      }
      break;
  } });
}

const ScaleIconServiceDevicesService = ServiceDevicesService;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconServiceDevicesService, defineCustomElement };
