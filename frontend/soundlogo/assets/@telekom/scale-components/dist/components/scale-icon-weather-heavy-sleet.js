...
const WeatherHeavySleet = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-heavy-sleet", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-heavy-sleet"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-heavy-sleet":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherHeavySleet);
      }
      break;
  } });
}

const ScaleIconWeatherHeavySleet = WeatherHeavySleet;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherHeavySleet, defineCustomElement };
