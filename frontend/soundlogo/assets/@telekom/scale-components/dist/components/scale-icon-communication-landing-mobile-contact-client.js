...
const CommunicationLandingMobileContactClient = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-landing-mobile-contact-client", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-landing-mobile-contact-client"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-landing-mobile-contact-client":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationLandingMobileContactClient);
      }
      break;
  } });
}

const ScaleIconCommunicationLandingMobileContactClient = CommunicationLandingMobileContactClient;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationLandingMobileContactClient, defineCustomElement };
