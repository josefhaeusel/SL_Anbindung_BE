...
const NavigationExternalLink = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-navigation-external-link", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-navigation-external-link"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-navigation-external-link":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, NavigationExternalLink);
      }
      break;
  } });
}

const ScaleIconNavigationExternalLink = NavigationExternalLink;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconNavigationExternalLink, defineCustomElement };
