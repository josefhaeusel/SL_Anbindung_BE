...
const ContentFood = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-food"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-food":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentFood);
      }
      break;
  } });
}

const ScaleIconContentFood = ContentFood;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentFood, defineCustomElement };
