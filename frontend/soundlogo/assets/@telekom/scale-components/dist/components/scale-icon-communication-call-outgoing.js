...
const CommunicationCallOutgoing = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-call-outgoing", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-call-outgoing"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-call-outgoing":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationCallOutgoing);
      }
      break;
  } });
}

const ScaleIconCommunicationCallOutgoing = CommunicationCallOutgoing;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationCallOutgoing, defineCustomElement };
