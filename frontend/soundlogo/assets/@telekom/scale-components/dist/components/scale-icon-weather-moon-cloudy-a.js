...
const WeatherMoonCloudyA = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-moon-cloudy-a", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-moon-cloudy-a"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-moon-cloudy-a":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherMoonCloudyA);
      }
      break;
  } });
}

const ScaleIconWeatherMoonCloudyA = WeatherMoonCloudyA;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherMoonCloudyA, defineCustomElement };
