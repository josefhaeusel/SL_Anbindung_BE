...
const ContentTariffs = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-tariffs"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-tariffs":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentTariffs);
      }
      break;
  } });
}

const ScaleIconContentTariffs = ContentTariffs;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentTariffs, defineCustomElement };
