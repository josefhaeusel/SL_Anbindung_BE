...
const HomeWifiConnected = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-home-wifi-connected", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-home-wifi-connected"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-home-wifi-connected":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HomeWifiConnected);
      }
      break;
  } });
}

const ScaleIconHomeWifiConnected = HomeWifiConnected;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconHomeWifiConnected, defineCustomElement };
