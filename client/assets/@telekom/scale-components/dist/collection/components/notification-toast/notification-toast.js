 ...
 */
import { Component, Prop, Method, h, State, Element, Host, Event, } from '@stencil/core';
...
export class NotificationToast {
        ...
        h("div", { role: "alert", style: { display: `${this.opened ? '' : 'none'}` }, class: this.getCssClassMap(), part: this.getBasePartMap(), tabindex: "0" },
          ...
          h("div", { class: "notification-toast__text-container" },
            ...
            h("scale-link", { href: this.href, class: "notification-toast__link", role: "link" },
              h("slot", { name: "link" }))),
          h("button", { part: "button-dismissable", type: "button", class: "notification-toast__button-close", onClick: () => this.close(), tabindex: 0, "aria-label": this.closeButtonLabel, title: this.closeButtonTitle, onKeyDown: (e) => {
              if (e.key === 'Enter') {
                this.close();
              }
            } },
  ...
  static get events() { return [{
      ...
      "docs": {
        "tags": [],
        "text": "Triggered when the notification toast closing process begins"
      },
      "complexType": {
        "original": "void",
        "resolved": "void",
      ...
      "docs": {
        "tags": [],
        "text": "Triggered when the notification toast has been dismissed"
      },
      "complexType": {
        "original": "void",
        "resolved": "void",
