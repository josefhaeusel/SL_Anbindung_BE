...
const HomeSlowWifi = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-home-slow-wifi"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-home-slow-wifi":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HomeSlowWifi);
      }
      break;
  } });
}

const ScaleIconHomeSlowWifi = HomeSlowWifi;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconHomeSlowWifi, defineCustomElement };
