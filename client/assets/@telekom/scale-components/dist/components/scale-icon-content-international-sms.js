...
const ContentInternationalSms = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-international-sms", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-international-sms"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-international-sms":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentInternationalSms);
      }
      break;
  } });
}

const ScaleIconContentInternationalSms = ContentInternationalSms;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentInternationalSms, defineCustomElement };
