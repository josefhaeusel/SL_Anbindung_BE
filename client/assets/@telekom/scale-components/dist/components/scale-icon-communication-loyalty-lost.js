...
const CommunicationLoyaltyLost = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-loyalty-lost", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-loyalty-lost"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-loyalty-lost":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationLoyaltyLost);
      }
      break;
  } });
}

const ScaleIconCommunicationLoyaltyLost = CommunicationLoyaltyLost;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationLoyaltyLost, defineCustomElement };
