...
const UserFileHandshake = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-user-file-handshake", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-user-file-handshake"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-user-file-handshake":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UserFileHandshake);
      }
      break;
  } });
}

const ScaleIconUserFileHandshake = UserFileHandshake;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconUserFileHandshake, defineCustomElement };
