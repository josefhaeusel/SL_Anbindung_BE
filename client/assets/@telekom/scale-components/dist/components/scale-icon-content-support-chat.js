...
const ContentSupportChat = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-support-chat", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-support-chat"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-support-chat":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentSupportChat);
      }
      break;
  } });
}

const ScaleIconContentSupportChat = ContentSupportChat;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentSupportChat, defineCustomElement };
