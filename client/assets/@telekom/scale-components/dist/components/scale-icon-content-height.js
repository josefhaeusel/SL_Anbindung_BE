...
const ContentHeight = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-height"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-height":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentHeight);
      }
      break;
  } });
}

const ScaleIconContentHeight = ContentHeight;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentHeight, defineCustomElement };
