...
const DeviceTwitchingOpenState = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-twitching-open-state", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-twitching-open-state"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-twitching-open-state":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceTwitchingOpenState);
      }
      break;
  } });
}

const ScaleIconDeviceTwitchingOpenState = DeviceTwitchingOpenState;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceTwitchingOpenState, defineCustomElement };
