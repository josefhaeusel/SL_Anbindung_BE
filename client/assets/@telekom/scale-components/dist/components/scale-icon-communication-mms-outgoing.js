...
const CommunicationMmsOutgoing = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-mms-outgoing", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-mms-outgoing"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-mms-outgoing":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationMmsOutgoing);
      }
      break;
  } });
}

const ScaleIconCommunicationMmsOutgoing = CommunicationMmsOutgoing;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationMmsOutgoing, defineCustomElement };
