...
const CommunicationRecipient = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-recipient", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-recipient"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-recipient":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationRecipient);
      }
      break;
  } });
}

const ScaleIconCommunicationRecipient = CommunicationRecipient;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationRecipient, defineCustomElement };
