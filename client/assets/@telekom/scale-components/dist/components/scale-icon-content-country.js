...
const ContentCountry = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-country"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-country":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentCountry);
      }
      break;
  } });
}

const ScaleIconContentCountry = ContentCountry;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentCountry, defineCustomElement };
