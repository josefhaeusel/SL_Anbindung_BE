...
const ServiceVpn = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-service-vpn"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-service-vpn":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ServiceVpn);
      }
      break;
  } });
}

const ScaleIconServiceVpn = ServiceVpn;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconServiceVpn, defineCustomElement };
