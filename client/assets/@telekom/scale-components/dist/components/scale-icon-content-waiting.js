...
const ContentWaiting = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-waiting"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-waiting":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentWaiting);
      }
      break;
  } });
}

const ScaleIconContentWaiting = ContentWaiting;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentWaiting, defineCustomElement };
