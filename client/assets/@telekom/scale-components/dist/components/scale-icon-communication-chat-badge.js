...
const CommunicationChatBadge = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-chat-badge", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-chat-badge"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-chat-badge":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationChatBadge);
      }
      break;
  } });
}

const ScaleIconCommunicationChatBadge = CommunicationChatBadge;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationChatBadge, defineCustomElement };
