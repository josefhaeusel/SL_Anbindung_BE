...
const ActionRandom = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-random"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-random":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionRandom);
      }
      break;
  } });
}

const ScaleIconActionRandom = ActionRandom;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionRandom, defineCustomElement };
