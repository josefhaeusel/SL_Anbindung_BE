...
const ActionMinusCircle = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-minus-circle"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-minus-circle":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionMinusCircle);
      }
      break;
  } });
}

const ScaleIconActionMinusCircle = ActionMinusCircle;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionMinusCircle, defineCustomElement };
