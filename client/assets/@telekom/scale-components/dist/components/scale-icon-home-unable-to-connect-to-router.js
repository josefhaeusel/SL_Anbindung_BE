...
const HomeUnableToConnectToRouter = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-home-unable-to-connect-to-router", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-home-unable-to-connect-to-router"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-home-unable-to-connect-to-router":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HomeUnableToConnectToRouter);
      }
      break;
  } });
}

const ScaleIconHomeUnableToConnectToRouter = HomeUnableToConnectToRouter;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconHomeUnableToConnectToRouter, defineCustomElement };
