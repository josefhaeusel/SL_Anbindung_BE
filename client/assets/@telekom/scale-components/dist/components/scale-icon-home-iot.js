...
const HomeIot = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-home-iot"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-home-iot":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HomeIot);
      }
      break;
  } });
}

const ScaleIconHomeIot = HomeIot;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconHomeIot, defineCustomElement };
