...
const HomeLightBulb = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-home-light-bulb"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-home-light-bulb":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HomeLightBulb);
      }
      break;
  } });
}

const ScaleIconHomeLightBulb = HomeLightBulb;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconHomeLightBulb, defineCustomElement };
