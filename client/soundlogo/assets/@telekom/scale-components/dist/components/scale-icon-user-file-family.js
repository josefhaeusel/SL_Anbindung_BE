...
const UserFileFamily = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-user-file-family"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-user-file-family":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UserFileFamily);
      }
      break;
  } });
}

const ScaleIconUserFileFamily = UserFileFamily;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconUserFileFamily, defineCustomElement };
