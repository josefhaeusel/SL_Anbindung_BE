...
const DeviceTwitchingClosedState = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-twitching-closed-state", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-twitching-closed-state"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-twitching-closed-state":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceTwitchingClosedState);
      }
      break;
  } });
}

const ScaleIconDeviceTwitchingClosedState = DeviceTwitchingClosedState;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceTwitchingClosedState, defineCustomElement };
