...
const ContentLoyalty = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-loyalty"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-loyalty":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentLoyalty);
      }
      break;
  } });
}

const ScaleIconContentLoyalty = ContentLoyalty;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentLoyalty, defineCustomElement };
