...
const ActionSend = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-send"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-send":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionSend);
      }
      break;
  } });
}

const ScaleIconActionSend = ActionSend;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionSend, defineCustomElement };
