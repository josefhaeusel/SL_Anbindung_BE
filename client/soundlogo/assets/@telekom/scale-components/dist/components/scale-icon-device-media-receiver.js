...
const DeviceMediaReceiver = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-media-receiver"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-media-receiver":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceMediaReceiver);
      }
      break;
  } });
}

const ScaleIconDeviceMediaReceiver = DeviceMediaReceiver;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceMediaReceiver, defineCustomElement };
