...
const UserFileFileCollection = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-user-file-file-collection", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-user-file-file-collection"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-user-file-file-collection":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UserFileFileCollection);
      }
      break;
  } });
}

const ScaleIconUserFileFileCollection = UserFileFileCollection;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconUserFileFileCollection, defineCustomElement };
