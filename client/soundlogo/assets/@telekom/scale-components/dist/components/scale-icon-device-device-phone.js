...
const DeviceDevicePhone = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-device-phone", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-device-phone"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-device-phone":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceDevicePhone);
      }
      break;
  } });
}

const ScaleIconDeviceDevicePhone = DeviceDevicePhone;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceDevicePhone, defineCustomElement };
