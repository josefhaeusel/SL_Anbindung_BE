...
const ActionPower = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-power"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-power":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionPower);
      }
      break;
  } });
}

const ScaleIconActionPower = ActionPower;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionPower, defineCustomElement };
