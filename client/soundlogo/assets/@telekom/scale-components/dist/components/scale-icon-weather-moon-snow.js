...
const WeatherMoonSnow = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-moon-snow", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-moon-snow"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-moon-snow":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherMoonSnow);
      }
      break;
  } });
}

const ScaleIconWeatherMoonSnow = WeatherMoonSnow;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherMoonSnow, defineCustomElement };
