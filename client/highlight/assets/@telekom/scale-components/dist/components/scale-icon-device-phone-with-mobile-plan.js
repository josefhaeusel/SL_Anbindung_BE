...
const DevicePhoneWithMobilePlan = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-phone-with-mobile-plan", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-phone-with-mobile-plan"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-phone-with-mobile-plan":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DevicePhoneWithMobilePlan);
      }
      break;
  } });
}

const ScaleIconDevicePhoneWithMobilePlan = DevicePhoneWithMobilePlan;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDevicePhoneWithMobilePlan, defineCustomElement };
