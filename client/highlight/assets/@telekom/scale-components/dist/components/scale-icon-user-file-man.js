...
const UserFileMan = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-user-file-man"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-user-file-man":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UserFileMan);
      }
      break;
  } });
}

const ScaleIconUserFileMan = UserFileMan;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconUserFileMan, defineCustomElement };
