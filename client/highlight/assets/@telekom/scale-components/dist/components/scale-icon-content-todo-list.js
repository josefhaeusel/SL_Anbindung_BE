...
const ContentTodoList = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-todo-list", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-todo-list"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-todo-list":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentTodoList);
      }
      break;
  } });
}

const ScaleIconContentTodoList = ContentTodoList;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentTodoList, defineCustomElement };
