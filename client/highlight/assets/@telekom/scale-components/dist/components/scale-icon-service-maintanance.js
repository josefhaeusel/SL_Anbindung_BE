...
const ServiceMaintanance = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-service-maintanance", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-service-maintanance"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-service-maintanance":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ServiceMaintanance);
      }
      break;
  } });
}

const ScaleIconServiceMaintanance = ServiceMaintanance;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconServiceMaintanance, defineCustomElement };
