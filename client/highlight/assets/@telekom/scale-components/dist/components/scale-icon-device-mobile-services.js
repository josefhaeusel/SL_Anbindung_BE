...
const DeviceMobileServices = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-mobile-services", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-mobile-services"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-mobile-services":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceMobileServices);
      }
      break;
  } });
}

const ScaleIconDeviceMobileServices = DeviceMobileServices;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceMobileServices, defineCustomElement };
