...
const ActionMore = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-more"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-more":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionMore);
      }
      break;
  } });
}

const ScaleIconActionMore = ActionMore;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionMore, defineCustomElement };
