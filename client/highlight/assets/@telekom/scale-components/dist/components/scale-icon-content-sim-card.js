...
const ContentSimCard = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-sim-card"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-sim-card":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentSimCard);
      }
      break;
  } });
}

const ScaleIconContentSimCard = ContentSimCard;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentSimCard, defineCustomElement };
