...
const UserFileContactsFromCloud = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-user-file-contacts-from-cloud", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-user-file-contacts-from-cloud"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-user-file-contacts-from-cloud":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UserFileContactsFromCloud);
      }
      break;
  } });
}

const ScaleIconUserFileContactsFromCloud = UserFileContactsFromCloud;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconUserFileContactsFromCloud, defineCustomElement };
