...
const ContentBirthday = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-birthday"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-birthday":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentBirthday);
      }
      break;
  } });
}

const ScaleIconContentBirthday = ContentBirthday;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentBirthday, defineCustomElement };
