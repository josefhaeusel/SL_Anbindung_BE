...
const HomeReducedWifi = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-home-reduced-wifi", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-home-reduced-wifi"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-home-reduced-wifi":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HomeReducedWifi);
      }
      break;
  } });
}

const ScaleIconHomeReducedWifi = HomeReducedWifi;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconHomeReducedWifi, defineCustomElement };
