...
const DeviceDeviceController = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-device-controller", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-device-controller"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-device-controller":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceDeviceController);
      }
      break;
  } });
}

const ScaleIconDeviceDeviceController = DeviceDeviceController;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceDeviceController, defineCustomElement };
