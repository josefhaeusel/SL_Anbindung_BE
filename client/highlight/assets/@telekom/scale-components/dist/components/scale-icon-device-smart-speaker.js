...
const DeviceSmartSpeaker = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-smart-speaker", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-smart-speaker"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-smart-speaker":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceSmartSpeaker);
      }
      break;
  } });
}

const ScaleIconDeviceSmartSpeaker = DeviceSmartSpeaker;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceSmartSpeaker, defineCustomElement };
