...
const TProduct2FaTelekomApp = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-t-product-2fa-telekom-app", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-t-product-2fa-telekom-app"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-t-product-2fa-telekom-app":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, TProduct2FaTelekomApp);
      }
      break;
  } });
}

const ScaleIconTProduct2faTelekomApp = TProduct2FaTelekomApp;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconTProduct2faTelekomApp, defineCustomElement };
