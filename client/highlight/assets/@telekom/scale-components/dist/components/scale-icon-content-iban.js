...
const ContentIban = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-iban"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-iban":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentIban);
      }
      break;
  } });
}

const ScaleIconContentIban = ContentIban;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentIban, defineCustomElement };
