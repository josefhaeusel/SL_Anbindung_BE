...
const DeviceFax = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-fax"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-fax":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceFax);
      }
      break;
  } });
}

const ScaleIconDeviceFax = DeviceFax;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceFax, defineCustomElement };
