...
const WeatherThunderSnow = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-thunder-snow", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-thunder-snow"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-thunder-snow":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherThunderSnow);
      }
      break;
  } });
}

const ScaleIconWeatherThunderSnow = WeatherThunderSnow;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherThunderSnow, defineCustomElement };
