...
const NavigationCollapseUp = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-navigation-collapse-up", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement() {
  ...
  const components = ["scale-icon-navigation-collapse-up"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-navigation-collapse-up":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, NavigationCollapseUp);
      }
      break;
  } });
}

export { NavigationCollapseUp as N, defineCustomElement as d };
