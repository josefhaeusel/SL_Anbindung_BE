...
const DeviceTvAndMobile = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-tv-and-mobile", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-tv-and-mobile"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-tv-and-mobile":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceTvAndMobile);
      }
      break;
  } });
}

const ScaleIconDeviceTvAndMobile = DeviceTvAndMobile;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceTvAndMobile, defineCustomElement };
