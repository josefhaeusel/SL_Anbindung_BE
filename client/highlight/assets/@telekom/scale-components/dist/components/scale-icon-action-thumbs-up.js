...
const ActionThumbsUp = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-thumbs-up"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-thumbs-up":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionThumbsUp);
      }
      break;
  } });
}

const ScaleIconActionThumbsUp = ActionThumbsUp;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionThumbsUp, defineCustomElement };
