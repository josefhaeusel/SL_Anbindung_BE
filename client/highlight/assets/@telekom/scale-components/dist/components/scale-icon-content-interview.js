...
const ContentInterview = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-interview", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-interview"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-interview":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentInterview);
      }
      break;
  } });
}

const ScaleIconContentInterview = ContentInterview;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentInterview, defineCustomElement };
