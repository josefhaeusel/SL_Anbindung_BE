...
const DeviceMobileEquipment = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-mobile-equipment", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-mobile-equipment"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-mobile-equipment":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceMobileEquipment);
      }
      break;
  } });
}

const ScaleIconDeviceMobileEquipment = DeviceMobileEquipment;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceMobileEquipment, defineCustomElement };
