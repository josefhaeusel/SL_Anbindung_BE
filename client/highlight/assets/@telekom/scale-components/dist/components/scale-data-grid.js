...
const DataGrid = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  renderSettingsMenu() {
    ...
    })))), h("scale-menu-flyout-item", { id: "toggleVisibility", onClick: this.handleMenuListClick }, h("scale-icon-action-hide-password", { slot: "prefix" }), ((_b = this.localization) === null || _b === void 0 ? void 0 : _b.toggle) || 'Toggle Visibility', h("scale-menu-flyout-list", { slot: "sublist", "close-on-select": "false", id: "toggleVisibilityList" }, this.fields.map(({ label, type, visible = CELL_TYPES[type].defaults.visible !== undefined
...
function defineCustomElement$1() {
  ...
  const components = ["scale-data-grid", "scale-button", "scale-checkbox", "scale-dropdown-select", "scale-dropdown-select-item", "scale-helper-text", "scale-icon", "scale-icon-action-checkmark", "scale-icon-action-close", "scale-icon-action-hide-password", "scale-icon-action-minus", "scale-icon-action-sort", "scale-icon-action-success", "scale-icon-alert-error", "scale-icon-alert-information", "scale-icon-content-sort-indicator-down", "scale-icon-content-sort-indicator-up", "scale-icon-navigation-collapse-down", "scale-icon-navigation-collapse-up", "scale-icon-navigation-double-left", "scale-icon-navigation-double-right", "scale-icon-navigation-left", "scale-icon-navigation-right", "scale-icon-service-settings", "scale-link", "scale-menu-flyout", "scale-menu-flyout-item", "scale-menu-flyout-list", "scale-pagination", "scale-progress-bar", "scale-switch", "scale-tag", "scale-text-field"];
