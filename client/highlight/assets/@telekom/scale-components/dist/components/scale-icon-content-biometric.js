...
const ContentBiometric = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-biometric", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-biometric"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-biometric":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentBiometric);
      }
      break;
  } });
}

const ScaleIconContentBiometric = ContentBiometric;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentBiometric, defineCustomElement };
