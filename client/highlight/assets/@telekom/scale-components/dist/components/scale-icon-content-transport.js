...
const ContentTransport = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-transport", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-transport"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-transport":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentTransport);
      }
      break;
  } });
}

const ScaleIconContentTransport = ContentTransport;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentTransport, defineCustomElement };
