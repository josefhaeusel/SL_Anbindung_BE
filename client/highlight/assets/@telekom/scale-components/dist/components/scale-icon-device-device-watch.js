...
const DeviceDeviceWatch = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-device-watch", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-device-watch"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-device-watch":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceDeviceWatch);
      }
      break;
  } });
}

const ScaleIconDeviceDeviceWatch = DeviceDeviceWatch;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceDeviceWatch, defineCustomElement };
