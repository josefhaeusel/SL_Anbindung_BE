...
const ActionSearch = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-search"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-search":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionSearch);
      }
      break;
  } });
}

const ScaleIconActionSearch = ActionSearch;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionSearch, defineCustomElement };
