...
const ContentInStock = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-in-stock"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-in-stock":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentInStock);
      }
      break;
  } });
}

const ScaleIconContentInStock = ContentInStock;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentInStock, defineCustomElement };
