...
const WeatherMoonThunderSnow = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-moon-thunder-snow", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-moon-thunder-snow"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-moon-thunder-snow":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherMoonThunderSnow);
      }
      break;
  } });
}

const ScaleIconWeatherMoonThunderSnow = WeatherMoonThunderSnow;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherMoonThunderSnow, defineCustomElement };
