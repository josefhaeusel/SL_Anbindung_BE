...
const WeatherCloudyThunderSnow = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-cloudy-thunder-snow", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-cloudy-thunder-snow"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-cloudy-thunder-snow":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherCloudyThunderSnow);
      }
      break;
  } });
}

const ScaleIconWeatherCloudyThunderSnow = WeatherCloudyThunderSnow;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherCloudyThunderSnow, defineCustomElement };
