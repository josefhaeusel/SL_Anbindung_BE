...
const CommunicationSms = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-sms", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-sms"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-sms":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationSms);
      }
      break;
  } });
}

const ScaleIconCommunicationSms = CommunicationSms;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationSms, defineCustomElement };
