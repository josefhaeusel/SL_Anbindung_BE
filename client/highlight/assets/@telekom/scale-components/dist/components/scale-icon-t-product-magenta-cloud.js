...
const TProductMagentaCloud = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-t-product-magenta-cloud", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-t-product-magenta-cloud"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-t-product-magenta-cloud":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, TProductMagentaCloud);
      }
      break;
  } });
}

const ScaleIconTProductMagentaCloud = TProductMagentaCloud;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconTProductMagentaCloud, defineCustomElement };
