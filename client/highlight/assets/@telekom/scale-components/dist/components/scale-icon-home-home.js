...
const HomeHome = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-home-home"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-home-home":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HomeHome);
      }
      break;
  } });
}

const ScaleIconHomeHome = HomeHome;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconHomeHome, defineCustomElement };
