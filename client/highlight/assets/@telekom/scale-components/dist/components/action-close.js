...
const ActionClose = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["scale-icon-action-close"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-close":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionClose);
      }
      break;
  } });
}

export { ActionClose as A, defineCustomElement as d };
