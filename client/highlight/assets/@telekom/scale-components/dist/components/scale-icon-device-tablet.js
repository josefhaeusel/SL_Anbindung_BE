...
const DeviceTablet = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-tablet"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-tablet":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceTablet);
      }
      break;
  } });
}

const ScaleIconDeviceTablet = DeviceTablet;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceTablet, defineCustomElement };
