...
const WeatherMoonThunderRain = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-moon-thunder-rain", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-moon-thunder-rain"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-moon-thunder-rain":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherMoonThunderRain);
      }
      break;
  } });
}

const ScaleIconWeatherMoonThunderRain = WeatherMoonThunderRain;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherMoonThunderRain, defineCustomElement };
