...
const ContentHourGlass = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-hour-glass", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-hour-glass"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-hour-glass":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentHourGlass);
      }
      break;
  } });
}

const ScaleIconContentHourGlass = ContentHourGlass;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentHourGlass, defineCustomElement };
