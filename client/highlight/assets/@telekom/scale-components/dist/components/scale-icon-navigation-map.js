...
const NavigationMap = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-navigation-map"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-navigation-map":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, NavigationMap);
      }
      break;
  } });
}

const ScaleIconNavigationMap = NavigationMap;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconNavigationMap, defineCustomElement };
