...
const CommunicationLoyaltyEarned = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-loyalty-earned", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-loyalty-earned"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-loyalty-earned":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationLoyaltyEarned);
      }
      break;
  } });
}

const ScaleIconCommunicationLoyaltyEarned = CommunicationLoyaltyEarned;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationLoyaltyEarned, defineCustomElement };
