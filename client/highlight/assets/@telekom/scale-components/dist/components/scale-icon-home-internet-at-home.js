...
const HomeInternetAtHome = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-home-internet-at-home", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-home-internet-at-home"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-home-internet-at-home":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HomeInternetAtHome);
      }
      break;
  } });
}

const ScaleIconHomeInternetAtHome = HomeInternetAtHome;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconHomeInternetAtHome, defineCustomElement };
