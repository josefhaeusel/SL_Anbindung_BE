...
const ContentFolder = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-folder"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-folder":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentFolder);
      }
      break;
  } });
}

const ScaleIconContentFolder = ContentFolder;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentFolder, defineCustomElement };
