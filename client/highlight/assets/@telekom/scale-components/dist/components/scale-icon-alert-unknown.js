...
const AlertUnknown = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-alert-unknown"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-alert-unknown":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, AlertUnknown);
      }
      break;
  } });
}

const ScaleIconAlertUnknown = AlertUnknown;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconAlertUnknown, defineCustomElement };
