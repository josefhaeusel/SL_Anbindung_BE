...
const UserFileIdCard = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-user-file-id-card", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-user-file-id-card"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-user-file-id-card":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UserFileIdCard);
      }
      break;
  } });
}

const ScaleIconUserFileIdCard = UserFileIdCard;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconUserFileIdCard, defineCustomElement };
