...
const AlertPasswordBreaking = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-alert-password-breaking", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-alert-password-breaking"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-alert-password-breaking":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, AlertPasswordBreaking);
      }
      break;
  } });
}

const ScaleIconAlertPasswordBreaking = AlertPasswordBreaking;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconAlertPasswordBreaking, defineCustomElement };
