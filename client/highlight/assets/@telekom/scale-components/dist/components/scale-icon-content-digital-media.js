...
const ContentDigitalMedia = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-digital-media", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-digital-media"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-digital-media":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentDigitalMedia);
      }
      break;
  } });
}

const ScaleIconContentDigitalMedia = ContentDigitalMedia;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentDigitalMedia, defineCustomElement };
