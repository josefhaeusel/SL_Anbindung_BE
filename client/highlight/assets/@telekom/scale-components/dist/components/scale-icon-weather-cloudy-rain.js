...
const WeatherCloudyRain = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-cloudy-rain", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-cloudy-rain"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-cloudy-rain":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherCloudyRain);
      }
      break;
  } });
}

const ScaleIconWeatherCloudyRain = WeatherCloudyRain;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherCloudyRain, defineCustomElement };
