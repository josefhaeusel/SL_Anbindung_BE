...
const ActionMinimizeScreen = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-action-minimize-screen", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-minimize-screen"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-minimize-screen":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionMinimizeScreen);
      }
      break;
  } });
}

const ScaleIconActionMinimizeScreen = ActionMinimizeScreen;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionMinimizeScreen, defineCustomElement };
