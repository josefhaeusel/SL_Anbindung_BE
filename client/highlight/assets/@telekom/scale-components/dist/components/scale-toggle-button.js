...
let i = 0;
const ToggleButton = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-toggle-button"];
...
const ScaleToggleButton = ToggleButton;
const defineCustomElement = defineCustomElement$1;

export { ScaleToggleButton, defineCustomElement };
