...
const AlertAntivirusProtection = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-alert-antivirus-protection", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-alert-antivirus-protection"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-alert-antivirus-protection":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, AlertAntivirusProtection);
      }
      break;
  } });
}

const ScaleIconAlertAntivirusProtection = AlertAntivirusProtection;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconAlertAntivirusProtection, defineCustomElement };
