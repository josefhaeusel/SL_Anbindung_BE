...
const WeatherCloudySleet = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-cloudy-sleet", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-cloudy-sleet"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-cloudy-sleet":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherCloudySleet);
      }
      break;
  } });
}

const ScaleIconWeatherCloudySleet = WeatherCloudySleet;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherCloudySleet, defineCustomElement };
