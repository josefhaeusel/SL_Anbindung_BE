...
const CommunicationMmsIncoming = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-mms-incoming", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-mms-incoming"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-mms-incoming":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationMmsIncoming);
      }
      break;
  } });
}

const ScaleIconCommunicationMmsIncoming = CommunicationMmsIncoming;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationMmsIncoming, defineCustomElement };
