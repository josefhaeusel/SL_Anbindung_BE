...
const WeatherMoonSleet = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-moon-sleet", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-moon-sleet"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-moon-sleet":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherMoonSleet);
      }
      break;
  } });
}

const ScaleIconWeatherMoonSleet = WeatherMoonSleet;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherMoonSleet, defineCustomElement };
