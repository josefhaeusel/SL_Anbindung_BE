...
const WeatherThunderRain = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-weather-thunder-rain", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-weather-thunder-rain"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-weather-thunder-rain":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherThunderRain);
      }
      break;
  } });
}

const ScaleIconWeatherThunderRain = WeatherThunderRain;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconWeatherThunderRain, defineCustomElement };
