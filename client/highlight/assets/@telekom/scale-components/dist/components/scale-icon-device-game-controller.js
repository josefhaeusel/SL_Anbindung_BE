...
const DeviceGameController = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-game-controller", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-game-controller"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-game-controller":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceGameController);
      }
      break;
  } });
}

const ScaleIconDeviceGameController = DeviceGameController;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceGameController, defineCustomElement };
