...
const CommunicationFeedback = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-feedback", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-feedback"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-feedback":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationFeedback);
      }
      break;
  } });
}

const ScaleIconCommunicationFeedback = CommunicationFeedback;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationFeedback, defineCustomElement };
