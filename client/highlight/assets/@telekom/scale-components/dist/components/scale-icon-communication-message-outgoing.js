...
const CommunicationMessageOutgoing = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-message-outgoing", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-message-outgoing"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-message-outgoing":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationMessageOutgoing);
      }
      break;
  } });
}

const ScaleIconCommunicationMessageOutgoing = CommunicationMessageOutgoing;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationMessageOutgoing, defineCustomElement };
