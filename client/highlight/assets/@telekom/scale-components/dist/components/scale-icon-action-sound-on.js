...
const ActionSoundOn = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-action-sound-on"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-action-sound-on":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActionSoundOn);
      }
      break;
  } });
}

const ScaleIconActionSoundOn = ActionSoundOn;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconActionSoundOn, defineCustomElement };
