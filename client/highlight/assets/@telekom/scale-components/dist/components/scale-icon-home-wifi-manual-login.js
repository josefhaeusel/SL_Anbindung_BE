...
const HomeWifiManualLogin = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-home-wifi-manual-login", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-home-wifi-manual-login"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-home-wifi-manual-login":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HomeWifiManualLogin);
      }
      break;
  } });
}

const ScaleIconHomeWifiManualLogin = HomeWifiManualLogin;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconHomeWifiManualLogin, defineCustomElement };
