...
const HomePreferredWifi = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-home-preferred-wifi", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-home-preferred-wifi"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-home-preferred-wifi":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HomePreferredWifi);
      }
      break;
  } });
}

const ScaleIconHomePreferredWifi = HomePreferredWifi;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconHomePreferredWifi, defineCustomElement };
