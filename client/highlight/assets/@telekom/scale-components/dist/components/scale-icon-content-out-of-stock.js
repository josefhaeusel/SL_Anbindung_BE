...
const ContentOutOfStock = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-out-of-stock", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-out-of-stock"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-out-of-stock":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentOutOfStock);
      }
      break;
  } });
}

const ScaleIconContentOutOfStock = ContentOutOfStock;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentOutOfStock, defineCustomElement };
