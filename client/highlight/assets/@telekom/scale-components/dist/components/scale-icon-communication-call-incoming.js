...
const CommunicationCallIncoming = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-call-incoming", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-call-incoming"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-call-incoming":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationCallIncoming);
      }
      break;
  } });
}

const ScaleIconCommunicationCallIncoming = CommunicationCallIncoming;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationCallIncoming, defineCustomElement };
