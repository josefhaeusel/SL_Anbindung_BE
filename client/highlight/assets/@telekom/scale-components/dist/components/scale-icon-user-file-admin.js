...
const UserFileAdmin = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-user-file-admin"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-user-file-admin":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UserFileAdmin);
      }
      break;
  } });
}

const ScaleIconUserFileAdmin = UserFileAdmin;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconUserFileAdmin, defineCustomElement };
