...
const DeviceScreenRotate = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-screen-rotate", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-screen-rotate"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-screen-rotate":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceScreenRotate);
      }
      break;
  } });
}

const ScaleIconDeviceScreenRotate = DeviceScreenRotate;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceScreenRotate, defineCustomElement };
