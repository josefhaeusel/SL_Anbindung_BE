...
const CommunicationEndCall = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-communication-end-call", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-communication-end-call"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-communication-end-call":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CommunicationEndCall);
      }
      break;
  } });
}

const ScaleIconCommunicationEndCall = CommunicationEndCall;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconCommunicationEndCall, defineCustomElement };
