...
const UserFileWoman = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-user-file-woman"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-user-file-woman":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UserFileWoman);
      }
      break;
  } });
}

const ScaleIconUserFileWoman = UserFileWoman;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconUserFileWoman, defineCustomElement };
