...
const ContentPrepaidActivate = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-prepaid-activate", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-prepaid-activate"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-prepaid-activate":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentPrepaidActivate);
      }
      break;
  } });
}

const ScaleIconContentPrepaidActivate = ContentPrepaidActivate;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentPrepaidActivate, defineCustomElement };
