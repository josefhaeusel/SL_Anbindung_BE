...
const DeviceChangeCamera = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-device-change-camera", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-device-change-camera"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-device-change-camera":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DeviceChangeCamera);
      }
      break;
  } });
}

const ScaleIconDeviceChangeCamera = DeviceChangeCamera;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconDeviceChangeCamera, defineCustomElement };
