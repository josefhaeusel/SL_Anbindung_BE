...
const ContentFlexibleTariffs = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "scale-icon-content-flexible-tariffs", {
    "size": [514],
    "fill": [1],
    "color": [1],
    "selected": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["scale-icon-content-flexible-tariffs"];
  components.forEach(tagName => { switch (tagName) {
    case "scale-icon-content-flexible-tariffs":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContentFlexibleTariffs);
      }
      break;
  } });
}

const ScaleIconContentFlexibleTariffs = ContentFlexibleTariffs;
const defineCustomElement = defineCustomElement$1;

export { ScaleIconContentFlexibleTariffs, defineCustomElement };
