...
function addSeconds(dirtyDate, dirtyAmount) {
  ...
  return index.addMilliseconds(dirtyDate, amount * 1000);
}
...
function formatDistance(dirtyDate, dirtyBaseDate, options) {
  ...
  var localizeOptions = index.assign(cloneObject(options), {
...
const Toast = class {
  ...
  render() {
    this.setToastTimeout();
    return (index$1.h(index$1.Host, null, this.styles && index$1.h("style", null, this.styles), index$1.h("style", null, this.transitions(this.toastHeightWithOffset)), index$1.h("style", null, this.animationStyle(this.toastHeightWithOffset)), index$1.h("div", { class: this.getCssClassMap(), part: this.getBasePartMap() }, index$1.h("div", { part: "header", class: "toast__header" }, index$1.h("slot", { name: "header" }), index$1.h("small", null, this.getTime()), index$1.h("a", { onClick: this.close }, index$1.h("span", { "aria-hidden": "true" }, "\u00D7"))), this.autoHide && (index$1.h("div", { part: "progress", class: "toast__progress", style: { width: `${this.progress}%` } }, "\u00A0")), index$1.h("div", { part: "body", class: "toast__body" }, index$1.h("slot", null)))));
  }
  ...
  getCssOrBasePartMap(mode) {
    ...
    return index$2.classnames(mode === 'basePart' ? 'base' : component, this.size && `${prefix}--size-${this.size}`, this.variant && `${prefix}--variant-${this.variant}`, !!this.opened && `${prefix}--opened`, !!!this.hideToast && `${prefix}--show`, !!this.hideToast && `${prefix}--hide`);
  }
