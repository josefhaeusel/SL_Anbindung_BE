...
const NavigationCollapseDown = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("svg", Object.assign({ class: "scale-icon", xmlns: "http://www.w3.org/2000/svg", width: this.size, height: this.size, viewBox: "0 0 24 24" }, ariaHidden, focusable), this.accessibilityTitle && index.h("title", null, this.accessibilityTitle), index.h("g", { fill: ((this.fill === 'currentColor') ? this.color : this.fill) }, this.selected ? (index.h("g", null, index.h("path", { d: "M12.003 16.488L5.137 10.12a1.251 1.251 0 011.7-1.833l5.166 4.791 5.166-4.79a1.25 1.25 0 111.7 1.832l-6.866 6.368z", "fill-rule": "evenodd" }))) : (index.h("g", null, index.h("path", { d: "M18.552 8.722a.75.75 0 00-1.06-.042l-5.491 5.069L6.51 8.68a.752.752 0 00-1.061.042.751.751 0 00.043 1.06l6.509 6.008 6.509-6.008a.75.75 0 00.042-1.06", "fill-rule": "evenodd" })))))));
  }
