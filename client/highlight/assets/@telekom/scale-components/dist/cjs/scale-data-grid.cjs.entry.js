...
const HTMLCell = {
  ...
  render: ({ content, component }) => {
    return (content && (index.h("scale-button", { variant: "secondary", size: "small", "icon-only": true, "inner-aria-label": `Activate to ${content.isExpanded ? 'collapse' : 'expand'} content`, onClick: () => {
...
const TagsCell = {
  ...
  render: ({ content }) => {
    ...
    return (index.h("ul", { class: `tbody__tag-list` }, tags.map((tag) => (index.h("li", null,
      index.h("scale-tag", { size: "small", type: "strong", color: tag.color }, tag.content))))));
  },
};
...
const DataGrid = class {
  ...
  renderSettingsMenu() {
    ...
    })))), index.h("scale-menu-flyout-item", { id: "toggleVisibility", onClick: this.handleMenuListClick }, index.h("scale-icon-action-hide-password", { slot: "prefix" }), ((_b = this.localization) === null || _b === void 0 ? void 0 : _b.toggle) || 'Toggle Visibility', index.h("scale-menu-flyout-list", { slot: "sublist", "close-on-select": "false", id: "toggleVisibilityList" }, this.fields.map(({ label, type, visible = CELL_TYPES[type].defaults.visible !== undefined
