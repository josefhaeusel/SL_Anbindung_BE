...
const TelekomFooterExtendedNavigation = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
  }
  //   @Prop() variant: 'standard' | 'slim' = 'standard';
  render() {
    return (index.h(index.Host, { part: "telekom-footer-extended-navigation" }, index.h("div", { part: "extended-navigation-container" }, index.h("slot", null))));
  }
  get hostElement() { return index.getElement(this); }
};
TelekomFooterExtendedNavigation.style = telekomFooterExtendedNavigationCss;

exports.scale_telekom_footer_extended_navigation = TelekomFooterExtendedNavigation;
