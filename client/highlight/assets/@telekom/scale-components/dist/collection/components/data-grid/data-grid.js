...
export class DataGrid {
    ...
    return (h("scale-menu-flyout", { class: `${name}__settings-menu` },
      ...
      h("scale-menu-flyout-list", null,
        this.isSortable && (h("scale-menu-flyout-item", { id: "sortBy", onClick: this.handleMenuListClick },
          ...
          ((_a = this.localization) === null || _a === void 0 ? void 0 : _a.sortBy) || 'Sort By',
        ...
        h("scale-menu-flyout-item", { id: "toggleVisibility", onClick: this.handleMenuListClick },
          ...
          ((_b = this.localization) === null || _b === void 0 ? void 0 : _b.toggle) || 'Toggle Visibility',
        ...
        this.selectable && (h("scale-menu-flyout-item", { "onScale-select": () => {
          ...
          ((_c = this.localization) === null || _c === void 0 ? void 0 : _c.select) || 'Select / Deselect All')),
        h("slot", { name: "menu" }))));
  }
  renderTable() {
    if (this.needsAutoWidthParse) {
  ...
  static get properties() { return {
    ...
    "localization": {
      ...
      "complexType": {
        "original": "{\n    sortBy: string;\n    toggle: string;\n    select: string;\n  }",
        "resolved": "{ sortBy: string; toggle: string; select: string; }",
        "references": {}
      },
      "required": false,
      "optional": true,
      "docs": {
        "tags": [],
        "text": "(optional) set localization for sort, toggle and select/deselect table\nDefault is English."
      }
    }
  }; }
