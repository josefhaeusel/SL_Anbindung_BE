  ...
  render() {
    ...
    return (h(Host, { role: this.checkable ? `menuitem${this.checkable}` : 'menuitem', "aria-checked": this.checkable == null ? false : checked, "aria-disabled": this.disabled ? 'true' : undefined, tabindex: "-1" },
      ...
      h("div", { class: this.getCssClassMap(), part: "base" },
        h("span", { part: "prefix", class: "menu-flyout-item__prefix" }, this.checkable == null ? (h("slot", { name: "prefix" })) : (h("scale-icon-action-checkmark", { class: "menu-flyout-item__check", size: 16 }))),
    ...
    "triggerEvent": {
      "complexType": {
        ...
        "references": {
          ...
          "HTMLScaleMenuFlyoutListElement": {
            "location": "global"
          }
        },
        "return": "Promise<void>"
