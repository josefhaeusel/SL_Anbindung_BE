...
export class MenuFlyoutList {
  ...
  render() {
    return (h(Host, { class: "scale-menu-flyout-list" },
  ...
  static get properties() { return {
    ...
    "brandHeaderDropdown": {
      ...
      "docs": {
        "tags": [],
        "text": "(optional) set to true when using in telekom-brand-header"
      },
      "attribute": "brand-header-dropdown",
      "reflect": false,
      "defaultValue": "false"
    },
    "styles": {
    ...
    "preventFlipVertical": {
      ...
      "docs": {
        "tags": [],
        "text": "(optional) set to true to prevent flipping orientation when off the screen vertically"
      },
      "attribute": "prevent-flip-vertical",
      "reflect": false,
      "defaultValue": "false"
    }
  }; }
